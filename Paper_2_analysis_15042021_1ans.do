...
sts list,  at(0(1)12 15 18 21 24) by(hdss_bis) failure  saving(`var', replace)
...
*save `var'_graph,replace
 ...
 log using estimation_taux_4_2,replace
** Estimation des taux de vaccination [measles, fj ]
foreach var of varlist polio0 bcg polio1 polio2 measles fj complete {
stset EventDate if echan==1, id(IndividualId) failure(`var') origin(time DoB) ///
time0(datebeg) scale(2629800000)exit(`var'==1 time DoB + (31557600000*2)+212000000)
sts list,  at(0 24) by(hdss_bis) failure  saving(`var', replace)
*sts graph, xlabel(0(5)60)
*save `var'_graph,replace
}
...
span size(vsmall))  ///
legend(off)) || ///
scatteri `max_BF021' 24 "Ouaga/Loti" `max_BF021_nl' 24 "Ouaga/Non loti" ///
 `max_GM011' 24 "Farafenni" `max_SN011' 24 "Niakhar", mlabsize(vsmall)  msymbol(i)

*graph save timing_bcg_by_hdss_0_24,replace
graph save timing_bcg_by_hdss_0_24_280521,replace
...
graph save timing_polio0_by_hdss_0_24_280521,replace
...
graph save timing_polio1_by_hdss_0_24_280521,replace
...
graph save timing_polio2_by_hdss_0_24_280521,replace
...
graph save timing_measles_by_hdss_0_24_210521,replace
...
graph save timing_fj_by_hdss__0_24_210521,replace

*save base_graphics_0_24,replace
save base_graphics_0_24_210521,replace
...
*By hdss
graph combine timing_bcg_by_hdss_0_24_280521.gph timing_polio0_by_hdss_0_24_280521.gph   ///
, row(1) note("Source: données des observatoires; calcul des auteurs.", span size(vsmall))
...
graph combine  timing_polio1_by_hdss_0_24_280521.gph timing_polio2_by_hdss_0_24_280521.gph   ///
, row(1) note("Source: données des observatoires; calcul des auteurs.", span size(vsmall))
...
graph combine  timing_fj_by_hdss__0_24_210521.gph  timing_measles_by_hdss_0_24_210521.gph  ///
, row(1) note("Source: données des observatoires; calcul des auteurs.", span size(vsmall))
...
log using ouaga_result_23052021_3_lotie,replace
stcox ib2.typo_2 ib0.nsib_cat_bis ib0.MigDeadY_interv_new ib0.MigDeadO_interv_new ib1.complete_OS_bis ///
i.gender i.twin ib10.pyear ///
ib1.y3_mother_age_birth_bis i.MO_education_bis  i.sit_mat_BF021  ///
...
log using ouaga_result_23052021_3_non_lotie,replace
stcox ib2.typo_2 ib0.nsib_cat_bis ib0.MigDeadY_interv_new ib0.MigDeadO_interv_new ib1.complete_OS_bis ///
i.gender i.twin ib10.pyear ///
ib1.y3_mother_age_birth_bis i.MO_education_bis  i.sit_mat_BF021  ///
...
log using farafenni_result_23052021_3,replace
stcox ib2.typo_2 ib0.nsib_cat_bis ib0.MigDeadY_interv_new ib0.MigDeadO_interv_new ib1.complete_OS_bis ///
i.gender i.twin ib1.pyear ///
ib1.y3_mother_age_birth_bis i.MO_education_bis  ///
if nomiss==1 & hdss=="GM011" &  y3_mother_age_birth_bis!=99, vce(cluster MotherId) iter(10)
log close
...
**Niakhar
log using niakhar_result_23052021_3,replace
stcox ib2.typo_2 ib0.nsib_cat_bis ib0.MigDeadY_interv_new ib0.MigDeadO_interv_new ib1.complete_OS_bis i.gender i.twin ib1.pyear  ///
ib1.y3_mother_age_birth_bis i.MO_education_bis i.sit_mat_SN011 ///
if nomiss==1 & hdss=="SN011" &  y3_mother_age_birth_bis!=99, vce(cluster MotherId) iter(10)
log close
...
title("Dilution des ressources", box bcolor(cyan) blcolor(magenta) bmargin(medium))) vertical ///
 ...
 eform ytitle(Hazards Ratio, size(small)) ///
 xtitle("{bf:Nombre enfants résidents (Ref: Aucun)}", size(small) color(blue) ) ///
 levels(95) legend(rows(1) position (12))
...
use base_year,clear
encode	hdss,gen(Hdss)

	
#delimit ;
label define lyear 2000"2000" 2001"2001" 2002"2002" 2003"2003" 2004"2003" ///
                  2005"2005" 2006"2006" 2007"2007" 2008"2008" 2009"2009" ///
				  2010"2010" 2011"2011" 2012"2012" 2013"2013" 2014"2014" ///
				  2015"2015" 2016"2016" 2017"2017" 2018"2018" 2019"2019", replace; 
...
label val year year
	...
	local xlab
    forval i=1/`count'{
        local xlab "`xlab' `=`i'-1' `" "`:lab (year) `i''" "'"
    }

	#delimit ;
	heatplot hrac i.Hdss i.year, 
