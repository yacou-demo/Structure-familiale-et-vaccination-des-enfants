...
display %20.0f clock("01Apr`num'","DMY")
display %20.0f clock("01Jul`num'","DMY")
display %20.0f clock("01Oct`num'","DMY")
}

cap drop calendar
stsplit calendar if echan==1, ///
   at(1262304000000 ///
       1270166400000 ///
       1278028800000 ///
       1285977600000 ///
...
cap drop pyear 
recode calendar (1262304000000=1 "Jan - Mars 2000") (1270166400000=2 "Avril - Juin 2000") ///
       (1278028800000=3 "Juil - Sept 2000") ///
       (1285977600000=4 "Oct - Dec 2000") ///
       (1293926400000=5 "Jan - Mars 2001") ///
       (1301702400000=6 "Avril - Juin 2001") ///
       (1309564800000=7 "Juil - Sept 2001") ///
       (1317513600000=8 "Oct - Dec 2001") ///
       (1325462400000=9 "Jan - Mars 2002") ///
       (1333238400000=10 "Avril - Juin 2002") ///
       (1341100800000=11 "Juil - Sept 2002") ///
       (1349049600000=12 "Oct - Dec 2002") ///
       (1356998400000=13 "Jan - Mars 2003") ///
       (1364774400000=14 "Avril - Juin 2003") ///
       (1372636800000=15 "Juil - Sept 2003") ///
       (1380585600000=16 "Oct - Dec 2003") ///
       (1388534400000=17 "Jan - Mars 2004") ///
       (1396396800000=18 "Avril - Juin 2004") ///
       (1404259200000=19 "Juil - Sept 2004") ///
       (1412208000000=20 "Oct - Dec 2004") ///
       (1420156800000=21 "Jan - Mars 2005") ///
       (1427932800000=22 "Avril - Juin 2005") ///
       (1435795200000=23 "Juil - Sept 2005") ///
       (1443744000000=24 "Oct - Dec 2005") ///
       (1451692800000=25 "Jan - Mars 2006") ///
       (1459468800000=26 "Avril - Juin 2006") ///
       (1467331200000=27 "Juil - Sept 2006") ///
       (1475280000000=28 "Oct - Dec 2006") ///
       (1483228800000=29 "Jan - Mars 2007") ///
       (1491004800000=30 "Avril - Juin 2007") ///
       (1498867200000=31 "Juil - Sept 2007") ///
       (1506816000000=32 "Oct - Dec 2007") ///
       (1514764800000=33 "Jan - Mars 2008") ///
       (1522627200000=34 "Avril - Juin 2008") ///
       (1530489600000=35 "Juil - Sept 2008") ///
       (1538438400000=36 "Oct - Dec 2008") ///
       (1546387200000=37 "Jan - Mars 2009") ///
       (1554163200000=38 "Avril - Juin 2009") ///
       (1562025600000=39 "Juil - Sept 2009") ///
       (1569974400000=40 "Oct - Dec 2009") ///
       (1577923200000=41 "Jan - Mars 2010") ///
       (1585699200000=42 "Avril - Juin 2010") ///
       (1593561600000=43 "Juil - Sept 2010")  ///
       (1601510400000=44 "Oct - Dec 2010") ///
       (1609459200000=45 "Jan - Mars 2011") ///
       (1617235200000=46 "Avril - Juin 2011") ///
       (1625097600000=47 "Juil - Sept 2011") ///
       (1633046400000=48 "Oct - Dec 2011")  ///
       (1640995200000=49 "Jan - Mars 2012") ///
       (1648857600000=50 "Avril - Juin 2012") ///
       (1656720000000=51 "Juil - Sept 2012") ///
       (1664668800000=52 "Oct - Dec 2012")  ///
       (1672617600000=53 "Jan - Mars 2013") ///
       (1680393600000=54 "Avril - Juin 2013") ///
       (1688256000000=55 "Juil - Sept 2013") ///
       (1696204800000=56 "Oct - Dec 2013") ///
       (1704153600000=57 "Jan - Mars 2014") ///
       (1711929600000=58 "Avril - Juin 2014") ///
       (1719792000000=59 "Juil - Sept 2014") ///
       (1727740800000=60 "Oct - Dec 2014") ///
       (1735689600000=61 "Jan - Mars 2015") ///
       (1743465600000=62 "Avril - Juin 2015") ///
       (1751328000000=63 "Juil - Sept 2015") ///
       (1759276800000=64 "Oct - Dec 2015") ///
       (1767225600000=65 "Jan - Mars 2016") ///
       (1775088000000=66 "Avril - Juin 2016") ///
       (1782950400000=67 "Juil - Sept 2016") ///
       (1790899200000=68 "Oct - Dec 2016") ///
       (1798848000000=69 "Jan - Mars 2017") ///
       (1806624000000=70 "Avril - Juin 2017") ///
       (1814486400000=71 "Juil - Sept 2017") ///
       (1822435200000=72 "Oct - Dec 2017") ///
       (1830384000000=73 "Jan - Mars 2018") ///
       (1838160000000=74 "Avril - Juin 2018") ///
       (1846022400000=75 "Juil - Sept 2018") ///
       (1853971200000=76 "Oct - Dec 2018") ///
       (1861920000000=77 "Jan - Mars 2019") ///
       (1869696000000=78 "Avril - Juin 2019") ///
       (1877558400000=79 "Juil - Sept 2019") ///
       (1885507200000=80 "Oct - Dec 2019") , gen(pyear)
...
save base_vaccin_V1_des_T,replace
XX

use base_vaccin_V1_des_T,clear
...
log using ouaga_result_23052021,replace
stcox ib2.typo_2 ib0.nsib_cat_bis ib0.MigDeadY_interv_new ib0.MigDeadO_interv_new ///
i.gender i.twin ib75.pyear ///
ib1.y3_mother_age_birth_bis i.MO_education_bis  i.sit_mat_BF021  ///
if nomiss==1 & hdss=="BF021" &  y3_mother_age_birth_bis!=99, vce(cluster MotherId) iter(10)
log close
